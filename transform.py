...
from kornia.augmentation import RandomAffine, RandomCrop, CenterCrop, RandomResizedCrop, ColorJitter
    ...
    def __init__(self, augmentation, shift_delta=4, image_shape=(96, 96)):
        ...
        for aug in self.augmentation:
            if aug == "affine":
                ...
                transformation = ColorJitter(brightness=0.05, contrast=0.05, saturation=0.05, hue=0.2)
            else:
